...
public class SAXXMLParserForWeather  extends DefaultHandler {
    ...
    public void endElement(String uri, String localName,
        ...
        if (name.equalsIgnoreCase("FACT") || name.equalsIgnoreCase("DAY_PART")) {
            ...
            values.put(WeatherDataBase.CITY, MainIntentWorkForWeather.city);
            values.put(WeatherDataBase.COUNTRY, MainIntentWorkForWeather.country);
            values.put(WeatherDataBase.YANDEX_ID, MainIntentWorkForWeather.yandex_id);
            ...
            MyActivity.weatherDataBase.insertWeather(MainIntentWorkForWeather.city, MainIntentWorkForWeather.country, MainIntentWorkForWeather.yandex_id, temperature_avg, weather_type,
