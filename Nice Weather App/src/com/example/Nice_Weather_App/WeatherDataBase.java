...
public class WeatherDataBase {
    ...
    // formal data
    public static final String DATABASE_NAME = "Weather_application";
    public static final int DATABASE_VERSION = 1;
    public static final String TABLE_WEATHER_NAME = "Loaded_weather";
    ...
    public long insertWeather(String city, String country, String yandex_id, String temperature_avg,
        ...
        if (MyActivity.CITY_YES.equals(city) && day_part.equals(MyActivity.KEY_NOW)) values.put(WEATHER_NOW, MyActivity.KEY_YES);
        else values.put(WEATHER_NOW, MyActivity.KEY_NO);
