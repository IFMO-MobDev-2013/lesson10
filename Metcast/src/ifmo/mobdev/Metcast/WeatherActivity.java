...
public class WeatherActivity extends Activity {
    ...
    private void startAlarm() {
        ...
        am.cancel(pi);
        am.setRepeating(AlarmManager.ELAPSED_REALTIME, SystemClock.elapsedRealtime(), TWENTY_MINUTES, pi);
    }

    private void initialiseReceivers(View page1, View page2, View page3) {
        myBroadcastReceiver = new WeatherBroadcastReceiver(page1, page2, page3, curCity);
