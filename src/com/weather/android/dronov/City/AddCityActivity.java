...
import com.weather.android.dronov.ForecastManipulator;
import com.weather.android.dronov.MainActivity;
import com.weather.android.dronov.R;
...
public class AddCityActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                weatherDB.insertData(new Forecast(cities.get(i).getCity(), cities.get(i).getCountry(), "", ""));
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(AddCityActivity.this, ForecastManipulator.class);
        startActivity(intent);
        finish();
    }
}
