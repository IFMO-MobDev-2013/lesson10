...
import java.lang.*;import java.lang.Exception;import java.lang.Object;import java.lang.String;import java.lang.StringBuilder;import java.net.URL;
...
public abstract class YandexTranslatorAPI {
  ...
  protected static void validateServiceState() throws Exception {
    if(apiKey==null||apiKey.length()<27) {
      throw new java.lang.RuntimeException("INVALID_API_KEY - Please set the API Key with your Yandex API Key");
    }
  }
